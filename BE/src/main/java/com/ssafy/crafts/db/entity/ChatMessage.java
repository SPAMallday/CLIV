...
//    private MessageType type;
    ...
    @Builder
    public ChatMessage(int id, String senderId, String message, Timestamp regDate, ChatRoom chatRoom) {
        this.id = id;
...
//        this.receiverId = receiverId;
     ...
     * @Method 설명 : 채팅방 생성
     */
    public ChatMessage createMessage(ChatRoom chatRoom, String senderId, String message){
